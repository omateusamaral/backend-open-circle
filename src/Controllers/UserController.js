...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.store = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, document_1, contract, username, occupation, email, telefone1, telefone2, userservice, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = request.body, document_1 = _a.document, contract = _a.contract, username = _a.username, occupation = _a.occupation, email = _a.email, telefone1 = _a.telefone1, telefone2 = _a.telefone2;
                        userservice = new UsersService_1.UserService();
                        return [4 /*yield*/, userservice.create(contract, document_1, username, occupation, email, telefone1, telefone2)];
                    case 1:
                        _b.sent();
    ...
    UserController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, document_2, contract, username, occupation, email, telefone1, telefone2, userservice, e_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        id = request.params.id;
                        _a = request.body, document_2 = _a.document, contract = _a.contract, username = _a.username, occupation = _a.occupation, email = _a.email, telefone1 = _a.telefone1, telefone2 = _a.telefone2;
                        userservice = new UsersService_1.UserService();
                        return [4 /*yield*/, userservice.update(document_2, contract, username, occupation, email, telefone1, telefone2, id)];
                    case 1:
                        _b.sent();
